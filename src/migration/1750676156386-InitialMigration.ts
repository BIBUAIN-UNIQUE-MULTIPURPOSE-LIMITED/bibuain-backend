...
export class InitialMigration1750676156386 implements MigrationInterface {
  name = "InitialMigration1750676156386";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."accounts_platform_enum" AS ENUM('noones', 'paxful', 'binance')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_type_enum" AS ENUM('system', 'individual')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_priority_enum" AS ENUM('high', 'medium', 'low')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "permissions" ("id" SERIAL NOT NULL, "permissionName" character varying(100) NOT NULL, "module" character varying(50) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_56583ae1f32a17a0925f4a5f893" UNIQUE ("permissionName"), CONSTRAINT "PK_920331560282b8bd21bb02290df" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "roles" ("id" SERIAL NOT NULL, "roleName" character varying(50) NOT NULL, "description" character varying(255), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_992f24b9d80eb1312440ca577f1" UNIQUE ("roleName"), CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."banks_tag_enum" AS ENUM('fresh', 'unfunded', 'funded', 'used', 'rollover')`,
    );
    await queryRunner.query(
      `CREATE TABLE "banks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bankName" character varying(100), "accountName" character varying(100) NOT NULL, "additionalNotes" character varying(255), "accountNumber" character varying(50) NOT NULL, "funds" double precision NOT NULL DEFAULT '0', "tag" "public"."banks_tag_enum" NOT NULL DEFAULT 'unfunded', "logs" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "shift_id" uuid, CONSTRAINT "PK_3975b5f684ec241e3901db62d77" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."shifts_shifttype_enum" AS ENUM('morning', 'afternoon', 'night')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."shifts_status_enum" AS ENUM('active', 'on_break', 'pending_approval', 'approved', 'rejected', 'ended', 'force_closed')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."shifts_shiftendtype_enum" AS ENUM('admin_force_close', 'pending_admin_approval')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_usertype_enum" AS ENUM('admin', 'payer', 'rater', 'ceo', 'customer-support')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "chats" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0117647b3c4a4e5ff198aeb6206" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."message_templates_type_enum" AS ENUM('welcome', 'payment_made', 'coin_release')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."message_templates_platform_enum" AS ENUM('paxful', 'noones')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_47c34966ec3fe38e6545ced04d" ON "message_templates" ("type", "platform", "isActive") `,
    );
    await queryRunner.query(
      `CREATE TABLE "rates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sellingPrice" numeric(50,8), "usdtNgnRate" numeric(50,8), "marketcap" numeric(20,2), "btcngnrate" numeric(20,4), "platformRates" jsonb, "platformCostPrices" jsonb DEFAULT '{}', "paxfulRate" numeric(50,8), "noonesRate" numeric(50,8), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2c804ed4019b80ce48eedba5cec" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."trades_platform_enum" AS ENUM('paxful', 'noones', 'binance')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."trades_status_enum" AS ENUM('pending', 'Active Funded', 'assigned', 'completed', 'cancelled', 'disputed', 'escalated', 'paid', 'successful', 'expired')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."trades_feedback_enum" AS ENUM('positive', 'negative')`,
    );
    await queryRunner.query(
      `CREATE TABLE "trades" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tradeHash" character varying(100) NOT NULL, "accountId" character varying(100) NOT NULL, "platform" "public"."trades_platform_enum", "status" "public"."trades_status_enum" NOT NULL DEFAULT 'Active Funded', "tradeStatus" character varying, "tradeDetails" json, "tradeChat" json, "feedback" "public"."trades_feedback_enum", "amount" numeric(20,2), "cryptoAmountRequested" numeric(20,8), "platform_created_at" TIMESTAMP WITH TIME ZONE, "cryptoAmountTotal" numeric(20,8), "feeCryptoAmount" numeric(20,8), "flagged" boolean NOT NULL DEFAULT false, "isEscalated" boolean NOT NULL DEFAULT false, "wasEscalated" boolean NOT NULL DEFAULT false, "escalationReason" text, "escalated_by_id" uuid, "assigned_cc_agent_id" uuid, "feePercentage" numeric(10,2), "sourceId" character varying(100), "responderUsername" character varying(100), "ownerUsername" character varying(100), "paymentMethod" character varying(100), "locationIso" character varying(2), "fiatCurrency" character varying(3), "cryptoCurrencyCode" character varying(10), "isActiveOffer" boolean NOT NULL DEFAULT false, "offerHash" character varying(100), "margin" numeric(10,2), "dollarRate" numeric(20,2), "btcRate" numeric(20,8), "btcAmount" numeric(20,8), "assigned_payer_id" uuid, "assignedAt" TIMESTAMP, "completedAt" TIMESTAMP, "btcNgnRate" double precision, "usdtNgnRate" double precision, "notes" character varying(255), "platformMetadata" jsonb, "activityLog" jsonb, "queuePosition" integer, "queuedAt" TIMESTAMP WITH TIME ZONE, "lastQueueCheck" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "parent_trade_id" uuid, CONSTRAINT "UQ_TRADE_HASH" UNIQUE ("tradeHash"), CONSTRAINT "PK_c6d7c36a837411ba5194dc58595" PRIMARY KEY ("id")); COMMENT ON COLUMN "trades"."accountId" IS 'External account identifier for the trade'; COMMENT ON COLUMN "trades"."platform_created_at" IS 'Original trade time from platform'; COMMENT ON COLUMN "trades"."queuePosition" IS 'Position in the trade queue (1-based index)'; COMMENT ON COLUMN "trades"."queuedAt" IS 'When the trade was added to the queue'; COMMENT ON COLUMN "trades"."lastQueueCheck" IS 'Last time the queue was checked/processed for this trade'; COMMENT ON COLUMN "trades"."createdAt" IS 'UTC timestamp of when the row was created'; COMMENT ON COLUMN "trades"."updatedAt" IS 'UTC timestamp of last update'`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_b2de1d752e0886761f55af9a39" ON "trades" ("tradeHash") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f8103b383ee5c33a3d3a72d95b" ON "trades" ("accountId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_ACCOUNT_PLATFORM" ON "trades" ("accountId", "platform") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD CONSTRAINT "FK_617e0dec72043a889cf5bb16c17" FOREIGN KEY ("related_account_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "banks" ADD CONSTRAINT "FK_703c435e39af3c7516d3cc60863" FOREIGN KEY ("shift_id") REFERENCES "shifts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "shifts" ADD CONSTRAINT "FK_dc1e84f1d1e75e990952c40859c" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "trades" ADD CONSTRAINT "FK_19214e66bdc060249a3b002c706" FOREIGN KEY ("parent_trade_id") REFERENCES "trades"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trades" ADD CONSTRAINT "FK_de5663a26e8e69b83e95e9436ed" FOREIGN KEY ("escalated_by_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trades" ADD CONSTRAINT "FK_06f435319092f4ba8677b09ac48" FOREIGN KEY ("assigned_cc_agent_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trades" ADD CONSTRAINT "FK_198b0372dec071a6d587cc3f94b" FOREIGN KEY ("assigned_payer_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "chat_participants" ADD CONSTRAINT "FK_b4129b3e21906ca57b503a1d834" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "trades" DROP CONSTRAINT "FK_198b0372dec071a6d587cc3f94b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "trades" DROP CONSTRAINT "FK_06f435319092f4ba8677b09ac48"`,
    );
    await queryRunner.query(
      `ALTER TABLE "trades" DROP CONSTRAINT "FK_de5663a26e8e69b83e95e9436ed"`,
    );
    await queryRunner.query(
      `ALTER TABLE "trades" DROP CONSTRAINT "FK_19214e66bdc060249a3b002c706"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "shifts" DROP CONSTRAINT "FK_dc1e84f1d1e75e990952c40859c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "banks" DROP CONSTRAINT "FK_703c435e39af3c7516d3cc60863"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notifications" DROP CONSTRAINT "FK_617e0dec72043a889cf5bb16c17"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f8103b383ee5c33a3d3a72d95b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b2de1d752e0886761f55af9a39"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_47c34966ec3fe38e6545ced04d"`,
    );
    await queryRunner.query(`DROP TABLE "message_templates"`);
    await queryRunner.query(
      `DROP TYPE "public"."message_templates_platform_enum"`,
    );
